 ...
 * 
 */
public class MoneyGiveResult extends Result {
	...
	public boolean performResult(Player player) {
		...
		EconomyResponse r = VaultDependency.economy.depositPlayer(p, money);
	...
	public List<String> getDescription() {
		...
		return Arrays.asList(ChatColor.RED + "Give " + money + " " + moneyType);
	}
}
